...
import { User, Mail, Phone, MapPin, Eye, EyeOff, Save, Wrench, Award } from 'lucide-react';
...
const TechnicianProfile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {/* Technician Stats */}
      <div className="card">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Statistiques technicien</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-blue-50 rounded-lg">
            <Wrench className="w-8 h-8 text-blue-600 mx-auto mb-2" />
            <h3 className="text-2xl font-bold text-blue-600">Technicien</h3>
            <p className="text-gray-600">Rôle actuel</p>
          </div>
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <Award className="w-8 h-8 text-green-600 mx-auto mb-2" />
            <h3 className="text-2xl font-bold text-green-600">Expert</h3>
            <p className="text-gray-600">Niveau d'accès</p>
          </div>
          <div className="text-center p-4 bg-purple-50 rounded-lg">
            <Wrench className="w-8 h-8 text-purple-600 mx-auto mb-2" />
            <h3 className="text-2xl font-bold text-purple-600">Diagnostic</h3>
